...
/**
 * This is a modification of the Subclipse Update Action.
 * Its called by the "SVoNt Update  Team ContextMenu Item
 * 
 * 
 * @author mrothe
 *
 */
public class SVoNtUpdateAction extends UpdateAction {
	...
	public void execute(IAction action) throws InterruptedException, InvocationTargetException {
		System.out.println("Executed SVoNt Update Action");
		
		//Here comes the old SVN Update Command Stuff
